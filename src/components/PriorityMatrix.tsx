...
const QUADRANTS = {
  q2: {
    ...
    tag: '[Priority] Important, Not Urgent 🟢',
  },
  q1: {
    id: 'q1',
  ...
  q4: {
    ...
    subtitle: 'Reduce/Avoid',
    icon: '⚪',
    bgColor: 'bg-gray-50',
    borderColor: 'border-gray-200',
    textColor: 'text-gray-700',
    tag: '[Priority] Not Important, Not Urgent ⚪',
  },
  q3: {
    id: 'q3',
    title: 'Urgent, Not Important',
    subtitle: 'Delegate/Handle Quickly',
    icon: '🟡',
    bgColor: 'bg-yellow-50',
    borderColor: 'border-yellow-200',
    textColor: 'text-yellow-700',
    tag: '[Priority] Urgent, Not Important 🟡',
  },
}
