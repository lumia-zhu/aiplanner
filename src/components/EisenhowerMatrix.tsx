        ...
        >
          ...
          <div className="flex-1 overflow-hidden flex flex-col p-6 gap-4">
            ...
            <div className="flex-1 min-h-0">
              ...
              <DroppableZone
                id="q2"
                className={`${QUADRANTS.q2.bgColor} ${QUADRANTS.q2.borderColor} border-2 rounded-lg p-4 flex flex-col`}
              >
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h3 className={`font-semibold flex items-center gap-2 ${QUADRANTS.q2.textColor}`}>
                      <span>{QUADRANTS.q2.icon}</span>
                      <span>{QUADRANTS.q2.title}</span>
                    </h3>
                    <p className="text-xs text-gray-500 mt-1">{QUADRANTS.q2.subtitle}</p>
                  </div>
              ...
              <DroppableZone
                id="q1"
                className={`${QUADRANTS.q1.bgColor} ${QUADRANTS.q1.borderColor} border-2 rounded-lg p-4 flex flex-col`}
              >
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h3 className={`font-semibold flex items-center gap-2 ${QUADRANTS.q1.textColor}`}>
                      <span>{QUADRANTS.q1.icon}</span>
                      <span>{QUADRANTS.q1.title}</span>
                    </h3>
                    <p className="text-xs text-gray-500 mt-1">{QUADRANTS.q1.subtitle}</p>
                  </div>
                  <span className="text-sm bg-white px-2 py-1 rounded text-gray-900 font-medium">
              ...
              <DroppableZone
                id="q4"
                className={`${QUADRANTS.q4.bgColor} ${QUADRANTS.q4.borderColor} border-2 rounded-lg p-4 flex flex-col`}
              >
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h3 className={`font-semibold flex items-center gap-2 ${QUADRANTS.q4.textColor}`}>
                      <span>{QUADRANTS.q4.icon}</span>
                      <span>{QUADRANTS.q4.title}</span>
                    </h3>
                    <p className="text-xs text-gray-500 mt-1">{QUADRANTS.q4.subtitle}</p>
                  </div>
                  <span className="text-sm bg-white px-2 py-1 rounded text-gray-900 font-medium">
              ...
              <DroppableZone
                id="q3"
                className={`${QUADRANTS.q3.bgColor} ${QUADRANTS.q3.borderColor} border-2 rounded-lg p-4 flex flex-col`}
              >
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h3 className={`font-semibold flex items-center gap-2 ${QUADRANTS.q3.textColor}`}>
                      <span>{QUADRANTS.q3.icon}</span>
                      <span>{QUADRANTS.q3.title}</span>
                    </h3>
                    <p className="text-xs text-gray-500 mt-1">{QUADRANTS.q3.subtitle}</p>
                  </div>
                  <span className="text-sm bg-white px-2 py-1 rounded text-gray-900 font-medium">
