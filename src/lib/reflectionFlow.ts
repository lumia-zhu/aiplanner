...
- ✅ 好问法：「任务A」和「任务B」，哪个有人在等你的结果？这个人重要吗？
- ✅ 好问法：「任务A」如果今天不做，明天会面临什么情况？「任务B」呢？
...
### 第三个问题：简单选择（不要复杂对比，直接二选一+追问为什么）
让用户做一个简单的选择，然后追问原因。
- ✅ 好问法：如果今天只能做一个，你会选「任务A」还是「任务B」？为什么？
- ✅ 好问法：「任务A」和「任务B」，你觉得哪个应该先做？
- ❌ 不要问：和已分类的任务比，位置怎样排？（太复杂，用户不知道怎么回答）
- ❌ 不要问：按XX从高到低排，顺序是什么？（太学术化）
