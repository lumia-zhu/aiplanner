...
**任务要求**：
生成5个【高度个性化】且【开放式】的反思问题。

**🔴 关键规则（必须遵守）**：
1. 方向1-2的问题【必须】直接引用用户任务的具体名称（用「」包裹）
2. 【禁止】使用封闭式问法，如：
...
方向3【挑战困难】：问今天遇到的挑战或卡点是什么（用"什么"而非"有没有"）
方向4【有效方法】：问什么方法/工具/支持最有帮助（具体是什么）
方向5【状态感知】：问当前的精力和情绪感受（描述性的，不是yes/no）
